...
/**
 * The calorie possibilities class if the calorie target specified by the user is 2100.
 *
	...
	public function return_meals_1_no() {
		...
		ob_start();
			...
			$sub_results_Arr= array_filter($this->results, function($value, $key) {
				return (
					( 1000 == $value->calorierange ) ||
					( 1100 == $value->calorierange )
				);
